 ...
 * 2022-06-15
 *
 * Test of Bidirectional graph with no properties
...
using Graph = graph::AdjacencyList<graph::tags::Bidirectional>;
...
int main()
{
    static_assert(graph::BidirectionalGraph<Graph> && graph::MutableGraph<Graph>);
    ...
    std::cout << "Test: AdjacencyList<tags::Bidirectional> satisfies MutableGraph concept\n\n";
    ...
    for (auto v : vertices(G)) {
        std::cout << v << ", out degree:   " << outDegree(v, G) << ", out edges: ";
