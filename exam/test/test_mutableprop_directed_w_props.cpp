 ...
 * 2022-06-15
 *
 * Test of Directed graph with properties
...
int main()
{
    static_assert(graph::IncidenceGraph<Graph> && graph::MutablePropertyGraph<Graph>);
    ...
    std::cout << "Test: AdjacencyList<tags::Directed, std::string, std::string> satisfies MutablePropertyGraph concept\n\n";
    std::cout << "|V| = " << numVertices(G) << ", Vertices: ";
